...
namespace AmphetamineSerializer.Tests.Scenarios
{
    ...
    [NUnit.Framework.DescriptionAttribute("SerializationJagged")]
    public partial class SerializationJaggedFeature
    {
        
        private TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "SerializationJagged.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "SerializationJagged", "\tSerialization and deserialization of the same class\r\n\tin order to ensure that re" +
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Serializing and deserializing containing jagged array produce the same result", new string[] {
                        "mytag"});
#line 6
